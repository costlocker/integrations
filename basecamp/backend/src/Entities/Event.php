...
class Event
{
    ...
    const REGISTER_COSTLOCKER_WEBHOOK = 0x100 | 0x10;
    const REGISTER_BASECAMP_WEBHOOK = 0x100 | 0x20;
    const WEBHOOK_BASECAMP = 0x200;
    const INVALID_COSTLOCKER_WEBHOOK = 0x400;
    const INVALID_COSTLOCKER_WEBHOOK_SIGNATURE = 0x400 | 0x1;
    const INVALID_COSTLOCKER_WEBHOOK_UNKNOWN_COMPANY = 0x400 | 0x2;
    const IMPORT_PROJECT_FROM_COSTLOCKER = 0x800;
