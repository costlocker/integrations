...
class Version20170608113835 extends AbstractMigration
{
...
SQL
        ...
        $this->addSql('CREATE INDEX IDX_B81EC12E572ECDB ON oauth2_tokens (bc_user_id)');
        $this->addSql(<<<SQL
            CREATE TABLE bc_accounts (
                id INT NOT NULL, 
                bc_user_id INT NOT NULL, 
...
SQL
        ...
        $this->addSql('CREATE INDEX IDX_5BEEEE04E572ECDB ON bc_accounts (bc_user_id)');
        $this->addSql(<<<SQL
...
SQL
        ...
        $this->addSql('CREATE INDEX IDX_CDB5C30CADB08941 ON bc_projects (bc_account_id)');
        $this->addSql('CREATE TABLE bc_users (id INT NOT NULL, data JSON NOT NULL, PRIMARY KEY(id))');
        $this->addSql(<<<SQL
...
SQL
        ...
        $this->addSql('CREATE TABLE bc_cl_users (cl_id INT NOT NULL, bc_id INT NOT NULL, PRIMARY KEY(cl_id, bc_id))');
...
SQL
        ...
        $this->addSql(<<<SQL
            ALTER TABLE oauth2_tokens ADD CONSTRAINT FK_B81EC12E572ECDB FOREIGN KEY (bc_user_id)
                REFERENCES bc_users (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE
SQL
        );
        $this->addSql(<<<SQL
            ALTER TABLE bc_accounts ADD CONSTRAINT FK_5BEEEE04E572ECDB FOREIGN KEY (bc_user_id)
                REFERENCES bc_users (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE
SQL
        );
        $this->addSql(<<<SQL
...
SQL
        ...
        $this->addSql(<<<SQL
            ALTER TABLE bc_projects ADD CONSTRAINT FK_CDB5C30CADB08941 FOREIGN KEY (bc_account_id)
                REFERENCES bc_accounts (id) ON DELETE RESTRICT NOT DEFERRABLE INITIALLY IMMEDIATE
SQL
        );
        $this->addSql(<<<SQL
...
SQL
        ...
        $this->addSql(<<<SQL
            ALTER TABLE bc_cl_users ADD CONSTRAINT FK_C90FC6DEF040AE19 FOREIGN KEY (cl_id)
                REFERENCES cl_users (id) NOT DEFERRABLE INITIALLY IMMEDIATE
SQL
        );
        $this->addSql(<<<SQL
            ALTER TABLE bc_cl_users ADD CONSTRAINT FK_C90FC6DE954397FF FOREIGN KEY (bc_id)
                REFERENCES bc_users (id) NOT DEFERRABLE INITIALLY IMMEDIATE
SQL
        );
        $this->addSql(<<<SQL
...
SQL
    ...
    {
        $this->addSql('ALTER TABLE bc_projects DROP CONSTRAINT FK_CDB5C30CADB08941');
        $this->addSql('ALTER TABLE events DROP CONSTRAINT FK_5387574A20B6C967');
        $this->addSql('ALTER TABLE oauth2_tokens DROP CONSTRAINT FK_B81EC12E572ECDB');
        $this->addSql('ALTER TABLE bc_accounts DROP CONSTRAINT FK_5BEEEE04E572ECDB');
        ...
        $this->addSql('DROP TABLE bc_users');
